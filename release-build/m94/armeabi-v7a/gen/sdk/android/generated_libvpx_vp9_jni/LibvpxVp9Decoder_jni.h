...
JNI_REGISTRATION_EXPORT extern const char kClassPath_org_webrtc_LibvpxVp9Decoder[];
const char kClassPath_org_webrtc_LibvpxVp9Decoder[] = "org/webrtc/LibvpxVp9Decoder";
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT std::atomic<jclass> g_org_webrtc_LibvpxVp9Decoder_clazz(nullptr);
...
inline jclass org_webrtc_LibvpxVp9Decoder_clazz(JNIEnv* env) {
  return base::android::LazyGetClass(env, kClassPath_org_webrtc_LibvpxVp9Decoder,
...
JNI_GENERATOR_EXPORT jlong Java_org_webrtc_LibvpxVp9Decoder_nativeCreateDecoder(
    JNIEnv* env,
    jclass jcaller) {
...
JNI_GENERATOR_EXPORT jboolean Java_org_webrtc_LibvpxVp9Decoder_nativeIsSupported(
    JNIEnv* env,
    jclass jcaller) {
